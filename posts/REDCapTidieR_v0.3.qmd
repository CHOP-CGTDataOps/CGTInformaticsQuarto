...
For example, consider the `physical_exam` table which contains data from both regular scheduled and unscheduled visits. (...)

*TODO: Please add a code example showing a table with scheduled and unscheduled visits.**
