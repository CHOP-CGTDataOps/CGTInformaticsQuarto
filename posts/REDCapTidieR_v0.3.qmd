...
One of the biggest updates to REDCapTidieR is support for REDCap "repeating events." For the uninitiated, REDCap allows for two types of repeating elements: [**instruments**](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#instrument) and [**events**](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#event). Note that each of these is only available to [longitudinal](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#longitudinal-project) [databases](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#database). When designing a REDCap [database](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#database), developers have the option to specify whether an event [repeats](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) all instruments together or [repeats](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) instruments independently of each other. From REDCap, this looks like:

![](images/repeating_events_instruments.png){fig-alt="REDCap Repeating Instruments Events"}

And for a given record that has both [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) [**instruments**](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#instrument) and [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) [**events**](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#event), this takes the visual form:

![](images/redcap_repeat_events_ui.png){fig-alt="REDCap Repeating Events UI" fig-align="center" width="447"}

Where the [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) [*instrument*](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#instrument) is shown in the [red box]{style="color: red;"} and the [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) [*event*](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#event) is shown in the [green box]{style="color: green;"}.

From the API, [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) [events](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#event) aren't captured much differently from [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) [instruments](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#instrument). In fact, no new column names are added to the data export. The same default columns of `redcap_repeat_instrument` and `redcap_repeat_instance` are used to indicate a [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) [instrument](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#instrument) when *both* are filled with data. It is the *lack* of data in `redcap_repeat_instrument` while data remains in `redcap_repeat_instance` which indicates a [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) [event](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#event). In the image below, a sample REDCap export is shown where the [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) [instrument](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#instrument) data is shown in the [red box]{style="color: red;"} and the [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) [*event*](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#event) data is shown in the [green box]{style="color: green;"}:

![](images/repeating_events_instrument_export.png){fig-alt="REDCap Repeating Event Export" fig-align="center" width="518"}

> It is important to note that [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) [instruments](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#instrument) **cannot** be included in [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) [events](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#event), and REDCapTidieR will throw an error if this is forced and detected!
